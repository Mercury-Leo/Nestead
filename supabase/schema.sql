...
-- share it, and the kitchen (recipes, pantry, diet profile, shopping list and
-- recipe photos). Prices are not here, and should be added when the feature
-- that needs them is being built, not before.
--
